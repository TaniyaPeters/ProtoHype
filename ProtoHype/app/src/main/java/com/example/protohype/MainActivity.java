...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreateNewAccountPress(View v){
    ...
    public void loginWithEmail(View v){
        ...
        if(email != null && password != null) {
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                Log.d("EmailLoginButton", "signInWithEmail:success");
                                FirebaseUser user = mAuth.getCurrentUser();
                                updateUI(user);
                            } else {
                                // If sign in fails, display a message to the user.
                                Log.w("EmailLoginButton", "signInWithEmail:failure", task.getException());
                                updateUI(null);
                            }
                        }
                    });
            ...
            Log.w("EmailLoginButton", "Invalid Entry");
        }
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            try {
                ...
                Log.w("GoogleLoginButton", "Google sign in failed", e);
                // ...
            }
        }
    }
    ...
    private void firebaseAuthWithGoogle(GoogleSignInAccount acct) {
        Log.d("GoogleLoginButton", "firebaseAuthWithGoogle:" + acct.getId());
        ...
        mAuth.signInWithCredential(credential)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            // Sign in success, update UI with the signed-in user's information
                            Log.d("GoogleLoginButton", "signInWithCredential:success");
                            FirebaseUser user = mAuth.getCurrentUser();
                            updateUI(user);
                        } else {
                            // If sign in fails, display a message to the user.
